...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('modules')->create('employee_snapshots', function (Blueprint $table) {
            ...
            $table->unique(['month_ref', 'username'], 'employee_snapshots_un');
        });
    }
    ...
    {
        Schema::connection('modules')->dropIfExists('employee_snapshots');
    }
};
